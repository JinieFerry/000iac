...
결과
```
>master@vmmaster1:~/k8s_install$ kubectl get pod
>NAME          READY   STATUS    RESTARTS   AGE
>hello-world   0/1     Pending   0          3m56s
>my-web        0/1     Pending   0          5s

>master@vmmaster1:~/k8s_install$ kubectl get nodes
>NAME        STATUS   ROLES           AGE     VERSION
>vmmaster1   Ready    control-plane   7m42s   v1.30.14
```
...
서비스 상태:
```
>master@vmmaster1:~/k8s_install$ kubectl get service my-web
>NAME     TYPE       CLUSTER-IP      EXTERNAL-IP   PORT(S)        AGE
>my-web   NodePort   10.101.186.62   <none>        80:31173/TCP   10s
```
포트확인 후 열어주기
```
sudo ufw allow 31173/tcp #위에서 확인한 포트 넘버 넣기 
```

taint 풀어주기: 아직 join 안 한 상태라서
```
...
* **예시:** `http://192.168.115.251:31173`
* 성공 시 보이는 화면
<img width="856" height="305" alt="image" src="https://github.com/user-attachments/assets/60afa28f-9b4e-46c3-b1b5-fe75a0319a39" />
