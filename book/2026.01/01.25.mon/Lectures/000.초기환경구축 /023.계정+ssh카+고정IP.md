https://github.com/putto4u/Lectures/blob/main/000.%EC%B4%88%EA%B8%B0%ED%99%98%EA%B2%BD%EA%B5%AC%EC%B6%95/023.%EA%B3%84%EC%A0%95%2Bssh%EC%B9%B4%2B%EA%B3%A0%EC%A0%95IP.md
실무에서는 여러 사내 자원(기기:노트북,데스크탑)까지 관리해서 많이 사용하는 방식

최초의 os가 깔려있고, 그 위에 하이퍼바이저를 까는 것: 일일이 다 작업해야 함<- 이걸 엔서블로 일괄작업 가능 함 : 윈도우 시스템하고도 엔서블로 작업할 일이 있음 서버만 작업하는 것은 아님
